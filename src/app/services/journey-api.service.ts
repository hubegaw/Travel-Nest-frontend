...
export class JourneyApiService extends ApiService {
  ...
  override getAllUserJourneys$Response(params?: {}, context?: HttpContext): Observable<StrictHttpResponse<Array<JourneyDto>>> {
    const rb = new RequestBuilder(this.rootUrl, ApiService.GetAllUserJourneysPath, 'get');
    if (params) {
    }
